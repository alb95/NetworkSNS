...
man_pages = [
    (master_doc, 'sns', u'NetworkSNS Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'NetworkSNS', u'NetworkSNS Documentation',
     author, 'NetworkSNS', 'One line description of project.',
     'Miscellaneous'),
]

html_logo = 'Network_SNS.png'
