...
.. autosummary::
   ...
   statistical_models.darn_simulation
   statistical_models.darn
   statistical_models.cdarn_simulation
   statistical_models.cdarn
   statistical_models.tgrg_simulation
   statistical_models.tgrg
   statistical_models.tgrg_directed_simulation
   statistical_models.tgrg_directed
   statistical_models.dar_tgrg_simulation
   statistical_models.dar_tgrg
   statistical_models.dar_tgrg_directed_simulation
   statistical_models.dar_tgrg_directed